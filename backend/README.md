...
## Project Structure
    ...
    ├── fragrant_waterfall_41798  # Django project configurations
...
1. Clone this repo and `cd fragrant_waterfall_41798`
...
2. Clone this repo and `cd fragrant_waterfall_41798`
